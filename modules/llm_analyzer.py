...
"""
    try:
        ...
        # Karakter kodlama hatalarını önlemek için ascii'ye zorla veya güvenli bir şekilde string'e çevir
        return f"Analiz hatası: {str(e).encode('utf-8', errors='ignore').decode('utf-8')}"
